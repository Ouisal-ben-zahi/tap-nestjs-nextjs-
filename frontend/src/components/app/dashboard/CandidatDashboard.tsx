  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link href="/app/mes-fichiers" className="flex items-center gap-2 px-5 py-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-white/60 hover:text-white/80 rounded-xl text-[13px] font-medium transition-all">
          <FolderOpen size={14} />
          Mes fichiers
        </Link>

        <Link href="/app/analyse-cv" className="flex items-center gap-2 px-5 py-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-white/60 hover:text-white/80 rounded-xl text-[13px] font-medium transition-all">
          <Search size={14} />
          Analyser mon CV
        </Link>
      </div>
