    ...
    <div className="max-w-[1100px] mx-auto">
      <div className="relative mb-8 pb-8 border-b border-white/[0.04]">
        ...
        <div className="relative">
          ...
          <h1 className="text-[28px] sm:text-[36px] font-bold text-white tracking-[-0.04em] font-heading">Simulateur d&apos;entretien</h1>
          <p className="text-white/45 text-[14px] mt-2 font-light">Préparez-vous avec notre IA qui simule de vrais entretiens adaptés à votre profil.</p>
        </div>
      </div>
      ...
      {statsQuery.isLoading ? (
        ...
        <>
          <div className="bg-purple-500/[0.06] border border-purple-500/15 rounded-2xl p-6 mb-8 flex items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center shrink-0">
              <Sparkles size={18} className="text-purple-500" />
            </div>
            <div>
              <h3 className="text-[14px] font-semibold text-white mb-1">Propulsé par l&apos;IA</h3>
              <p className="text-[13px] text-white/45 font-light">Les questions sont générées en fonction de votre CV, vos compétences et le poste visé.</p>
            </div>
          </div>

          <div className="flex items-center gap-3 mb-5">
            <div className="w-1 h-5 rounded-full bg-purple-500" />
            <h2 className="text-[13px] uppercase tracking-[2px] text-white/50 font-semibold">Types d&apos;entretien</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {interviewTypes.map((type, i) => {
              ...
              return (
                <div key={i} className="group bg-zinc-900/50 border border-white/[0.06] rounded-2xl p-6 hover:border-white/[0.12] transition-all duration-300 cursor-pointer">
                  ...
                  <h3 className="text-[15px] font-semibold text-white mb-2">{type.title}</h3>
                  <p className="text-[12px] text-white/40 leading-relaxed mb-4">{type.description}</p>
          ...
          <div className="bg-zinc-900/50 border border-white/[0.06] rounded-2xl p-6">
            <h3 className="text-[13px] uppercase tracking-[2px] text-white/50 font-semibold mb-5">Comment ça marche</h3>
